          ...
          <div class="container" >
              <div class="row">
                  <div class="panel panel-default widget" style="background-color: #e3ede9">
                   ...
                   @if($report->forApproval == true || ($report->forAssessment==true))
                    <button type="button" class="btn btn-block" style="background-color: #a5bab1" data-toggle="modal" data-target="#commentModal" ><strong>Add comment</strong></button>
                    @endif
                      </div>
                  </div>
              </div>
